//* this is a named export (you can have multiple per page) and only 1 default export at the bottom of the page
//* when an export is named think { }

// export default dummyData; //* this one is "unnamed" its the default of the page
